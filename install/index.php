			...
			if (file_exists('../classes/config.php')) : ?>
				<div class="row">
					<div class="col-md-8">
						...
						<p><span class='label label-danger'><?php _e('Important'); ?></span> <?php _e('Please delete or rename the install folder to prevent intrusion'); ?></p>
					</div>
					<div class="col-md-6">
						<h5><?php _e('What to do now?'); ?></h5>
						<p>Head to the <a href="../login.php">Login</a> <?php _e('page.'); ?></p>
					</div>
				</div> <?php
				include('footer.php');
				exit();
